...
{
    NSString *lastPathComponent = [LLVideoUtil getRelativePath:absolutedPath];
    //[LLVideoUtil getVideoPath] 这部分会因为重装应用而改变
    NSString *absolute = [[LLVideoUtil getVideoPath] stringByAppendingPathComponent:lastPathComponent];
    return absolute;
}
...
+ (NSString *)createAbsolutThumPath:(NSString *)snapshotId
{
    ...
    NSString *absolute = [[LLVideoUtil getVideoPath] stringByAppendingPathComponent:thumRelativePath];
    return absolute;
}
...
+ (NSString *)createAbsolutVideoPath:(NSString *)videoId
{
    ...
    NSString *absolute = [[LLVideoUtil getVideoPath] stringByAppendingPathComponent:videoRelativePath];
    return absolute;
}
